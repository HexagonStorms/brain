...
- [Invader Zim manual import pending](project_invader_zim_manual_import.md) — torrent added straight to qBittorrent (Pirate Bay season-filter bug, documented in elowynn-media-server/CLAUDE.md), needs Sonarr Manual Import once it finishes; delete this memory once done.
